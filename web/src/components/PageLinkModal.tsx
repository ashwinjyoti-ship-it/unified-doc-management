...
export default function PageLinkModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-[100] flex items-end md:items-center justify-center p-4" onClick={onClose}>
      <div className="card-surface w-full max-w-md max-h-[70vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
